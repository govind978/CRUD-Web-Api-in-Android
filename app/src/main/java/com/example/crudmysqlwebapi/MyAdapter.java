...
public class MyAdapter extends ArrayAdapter<Employee> {
    ...
    public MyAdapter(@NonNull Context context, List<Employee> arrayListEmployee) {
        super(context, R.layout.custom_array_list, arrayListEmployee);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_array_list,null,true);
